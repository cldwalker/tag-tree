...
This is a machine-tag, console bookmark manager which uses Rails3 under the hood. Machine tags are
...
== Setup
  1. Install rails3: `gem install rails --pre`
  2. Install necessary gems: `bundle install`
  3. Copy config/database.yml.example to config/database.yml and setup your db as needed.
  4. Run migrations: `rake db:migrate`
  5. Optionally setup your own commandline aliases at config/alias.yml using config/alias.yml.example as an example.
