...
Rails::Initializer.run do |config|
  ...
  # They can then be installed with "rake gems:install" on new installations.
   ...
   config.gem "cldwalker-hirb", :source=>"http://gems.github.com", :lib=>"hirb"
  ...
  config.action_controller.session = {
    :session_key => '_tag-tree_session',
    :secret      => 'ce8688d96a8256c3776c5168b4b7cbb98b499bc3d2523071dc86f6db39b29028c8d7a11bd7b71d2308785a377db66a5f031cf4a7c929bf7c7c97dd1766066871'
  }
